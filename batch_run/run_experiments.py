...
def main():
    ...
    #shared.model_name = "meta-llama_Llama-3.1-70B"
    ...
    # Parameters
    num_samples = 40  # Number of random samples to extract (adjust as needed)
    ...
    output_filename = 'generation_results_medium_bonus.json'
    try:
