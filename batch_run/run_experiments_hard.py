...
def main():
    ...
    # Parameters
    num_samples = 20  # Number of random samples to extract (adjust as needed)
    ...
    feature_levels = {
        ...
        'medium': {'delta_senso': 4.0, 'delta_acro': 40.0, 'delta_redgreen': 4.0},
        # 'strong': {'delta_senso': 4.0, 'delta_acro': 40.0, 'delta_redgreen': 4.0}
    }
    ...
    output_filename = 'generation_results_5.json'
    try:
