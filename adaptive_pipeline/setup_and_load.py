...
shared.model_name = os.environ.get('MODEL_NAME', "Meta-Llama-3.1-8B-Instruct-GPTQ-INT4")
...
if not os.path.exists(csv_path):
    ...
    all_classes = ['Auditory', 'Gustatory', 'Haptic', 'Interoceptive', 'Olfactory', 'Visual', 'Foot_leg', 'Hand_arm', 'Head', 'Mouth', 'Torso']
