...
ATTACK_TRANSLATION_OUTPUT_FILE = os.environ.get('ATTACK_TRANSLATION_OUTPUT_FILE', 'adaptive_outputs/attacked_translation.json')

def translate_text_deep_translator(text, src_lang='en', intermediate_lang='es', target_lang='en', retries=3, delay=2):
    """
    Function to translate text using deep-translator with back-and-forth translation.
    """
